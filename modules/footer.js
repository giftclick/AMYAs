export class Footer extends HTMLElement {
    constructor() {
        ...
        <div class="footer-nav">
            ...
            <ul>
                <li><a href="https://giftclick.github.io/AMYAs/quienessomos.html?scroll=quienes-somos-section">Acerca de AM</a></li>
                <li><a href="https://giftclick.github.io/AMYAs/separte.html?scroll=se-parte-section">Se Parte de AM</a></li>
            </ul>
        </div>
    </footer>
        `;
